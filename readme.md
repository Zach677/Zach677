...
<ul><li><a href=https://github.com/Cactus-proj/A-Philosophy-of-Software-Design-zh>Cactus-proj/A-Philosophy-of-Software-Design-zh</a><span> 《软件设计的哲学》中文翻译 | Chinese translation of A Philosophy of Software Design</span></li><li><a href=https://github.com/AsyncFuncAI/deepwiki-open>AsyncFuncAI/deepwiki-open</a><span> Open Source DeepWiki: AI-Powered Wiki Generator for GitHub/Gitlab/Bitbucket Repositories. Join the discord: https://discord.gg/gMwThUMeme</span></li><li><a href=https://github.com/cameroncooke/XcodeBuildMCP>cameroncooke/XcodeBuildMCP</a><span> A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients.</span></li><li><a href=https://github.com/Lakr233/AudioEditorKit>Lakr233/AudioEditorKit</a><span> Simplified audio editing library for Swift + UIKit.</span></li><li><a href=https://github.com/runjuu/InputSourcePro>runjuu/InputSourcePro</a><span> Switch and track your input sources with ease ✨</span></li></ul>

**Review Stared...**

<ul><li><a href=https://github.com/modelcontextprotocol/servers>modelcontextprotocol/servers</a><span> Model Context Protocol Servers</span></li><li><a href=https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools>x1xhlol/system-prompts-and-models-of-ai-tools</a><span> FULL v0, Cursor, Manus, Same.dev, Lovable, Devin, Replit Agent, Windsurf Agent & VSCode Agent (And other Open Sourced) System Prompts, Tools & AI Models.</span></li><li><a href=https://github.com/run-llama/llama-flow>run-llama/llama-flow</a><span> 🌊 Simple, event-driven and stream oriented workflow for TypeScript</span></li><li><a href=https://github.com/remix-run/remix>remix-run/remix</a><span> Build Better Websites. Create modern, resilient user experiences with web fundamentals.</span></li><li><a href=https://github.com/facebook/react-native>facebook/react-native</a><span> A framework for building native applications using React</span></li></ul>
...
<p align=center>感谢<a href=https://github.com/Innei>Innei</a>的项目,宝藏README.<br>此文件 <i>README</i> <b>间隔 3 小时</b>自动刷新生成！<br>刷新于：5/13/25, 2:03 AM<br>下一次刷新：5/13/25, 5:03 AM</p>
